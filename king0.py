...
def banner():
	clear()
	sol()
	ban='''ARIYAN.PHcheat.ph © Brute forse Facebook account
  ___  ______ _______   _____   _   _ 
 / _ \ | ___ \_   _\ \ / / _ \ | \ | |
/ /_\ \| |_/ / | |  \ V / /_\ \|  \| |
|  _  ||    /  | |   \ /|  _  || . ` |
| | | || |\ \ _| |_  | || | | || |\  |
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t©©😛 ARIYAN.PHcheat.ph [green]HACKER[white] 😛©©'))
...
def error():
	...
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/ARIYAN.PHcheat.ph")
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/ARIYANPHcheat')
	except:pass
